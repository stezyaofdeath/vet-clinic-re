...
public class GetOrdersByClient implements Command {
    ...
    public Object execute() {
        ...
        Query query = session.createSQLQuery(
                "select doc_id, doc_name, doc_surname, ms_id, ms_name, ms_cost, proc_date, proc_status, proc_realCost\n" +
                        "from procedures\n" +
        ...
        String[] keys = {
                "doc_id", "doc_name", "doc_surname", "ms_id", "ms_name", "ms_cost", "proc_date", "proc_status", "proc_realCost"
        };
